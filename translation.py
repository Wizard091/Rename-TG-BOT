...
SEE /help For My Features"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds Use @leech_group To Download From Links"
    NOT_AUTH_USER_TEXT = "CONTACT @Wizard09"
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @Wizard09"
    SAVED_CUSTOM_THUMB_NAIL = "Custom File thumbnail Saved ✅ This Is Permanent Thumbnail ᕙ(  • ‿ •  )ᕗ "
    DEL_ETED_CUSTOM_THUMB_NAIL = "Custom thumbnail cleared succesfully🤦"
    FF_MPEG_DEL_ETED_CUSTOM_MEDIA = "Media cleared succesfully."
    SAVED_RECVD_DOC_FILE = "File Downloaded Successfully😎"
    CUSTOM_CAPTION_UL_FILE = """@leech_group"""
    ...
    ➡ FOR Downloading Files At Highspeed Join @leech_group"""
